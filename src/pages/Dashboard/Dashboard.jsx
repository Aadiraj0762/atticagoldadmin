              ...
              <div className="d-flex right-page">
                <div className="d-flex justify-content-center mr-5">
                  ...
                  <div className="ml-3 mt-2">
                    <span className="sparkline_bar"></span>
                  </div>
                </div>
                <div className="d-flex justify-content-center">
                  ...
                  <div className="ml-3 mt-2">
                    <span className="sparkline_bar31"></span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="card overflow-hidden">
                  <div className="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    ...
                    <p className="tx-12 text-muted mb-2">
                      ...
                      template includes a detailed estimate of all costs.
                      <a href="">Learn more</a>
                    </p>
                  </div>
                  <div className="card-body pd-y-7">
                    <div className="area chart-legend mb-0">
                      <div>
                        <i className="mdi mdi-album text-primary mr-2"></i>
                        Total Budget
                      </div>
                      <div>
                        <i className="mdi mdi-album text-pink mr-2"></i>Amount
                        Used
                      </div>
                    </div>
                    <canvas id="project-budget" className="ht-300"></canvas>
                  </div>
                </div>
              </div>
                ...
                <div className="card overflow-hidden">
                  <div className="card-body pb-3">
                    ...
                    <p className="tx-12 text-muted mb-3">
                      In project, a task is an activity that needs to be
                      accomplished within a defined period of time or by a
              ...
              <div className="col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div className="card overflow-hidden">
                  <div className="card-header pb-0">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mg-b-10 mt-2">
                        Projects Workload
                      </h4>
                      <i className="mdi mdi-dots-horizontal text-gray"></i>
                    </div>
                    <p className="tx-12 text-muted mb-0">
                      In the Project Workload report, their remaining
                      assignments, completion dates, whether their work is
                      at-risk.
                      <a href="">Learn more</a>
                    </p>
                  </div>
                  <div className="card-body">
                    ...
                    <div className="pt-3">
                      <div className="row">
                        <div className="col-sm-8">
                          <h5 className="mb-0 tx-15 d-flex">
                            <span className="legend bg-primary-gradient brround"></span>
                            40.32%
                          </h5>
                          <p className="text-muted tx-13 mb-0">External</p>
                        </div>
                      ...
                      <div className="row">
                        <div className="col-sm-8">
                          <h6 className="mb-0 tx-15 d-flex">
                            <span className="legend bg-danger-gradient brround"></span>
                            40.73%
                          </h6>
                          <p className="text-muted tx-13 mb-0">Internal</p>
                        </div>
                        <div className="col-sm-4">
                    ...
                    <div className="pt-3">
                      <div className="row">
                        <div className="col-sm-8">
                          <h6 className="mb-0 tx-15 d-flex">
                            <span className="legend bg-success-gradient brround"></span>
                            50.12%
                          </h6>
                          <p className="text-muted tx-13 mb-0">Other</p>
                        </div>
                        <div className="col-sm-4">
              ...
              <div className="col-lg-12 col-xl-4 col-md-12 col-sm-12">
                <div className="card card-dashboard-events">
                  <div className="card-header pb-0">
                    ...
                    <p className="tx-12 text-muted mb-0">
                      It had the latest news and notes from the championship,
                      while previewing the upcoming event..
                      <a href="">Learn more</a>
                    </p>
                  </div>
                  <div className="card-body">
                    <div className="list-group">
                      <div className="list-group-item border-top-0">
                        <div className="event-indicator bg-primary-gradient"></div>
                        <label>
                          Nov 20
                          <span>Tuesday</span>
                        </label>
                        ...
                        <small>
                          <span className="tx-danger">Sold Out</span>
                          (3000 tickets sold)
                        </small>
                      </div>
                      <div className="list-group-item">
                        <div className="event-indicator bg-danger-gradient"></div>
                        <label>
                          Nov 23
                          <span>Friday</span>
                        </label>
                        ...
                        <small>
                          <span className="tx-warning">Sold Out Soon</span>
                          (12 tickets left)
                        </small>
                      </div>
                      <div className="list-group-item border-bottom-0">
                        <div className="event-indicator bg-info-gradient"></div>
                        <label>
                          Nov 23
                          <span>Friday</span>
                        </label>
                        ...
                        <small>
                          <span className="tx-success">Free Registration</span>
                          (Limited seats only)
                        </small>
                      </div>
                    </div>
                ...
                <div className="card overflow-hidden review-project">
                  <div className="card-body">
                    ...
                    <p className="tx-12 text-muted mb-3">
                      ...
                      product or service and thus activities that are undertaken
                      to accomplish routine activities cannot be considered
                      projects. <a href="">Learn more</a>
                    </p>
                      ...
                      <table className="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>01 Jan 2020</td>
                            <td>
                              <span className="badge badge-primary-gradient">
                                Ongoing
                              </span>
                            </td>
                            <td>15 March 2020</td>
                          ...
                          <tr>
                            ...
                            <td>03 March 2020</td>
                            <td>
                              <span className="badge badge-success-gradient">
                                Ongoing
                              </span>
                            </td>
                            <td>15 Jun 2020</td>
                          ...
                          <tr>
                            ...
                            <td>15 March 2020</td>
                            <td>
                              <span className="badge badge-danger-gradient">
                                Pending
                              </span>
                            </td>
                            <td>15 March 2020</td>
                          ...
                          <tr>
                            ...
                            <td>15 March 2020</td>
                            <td>
                              <span className="badge badge-pink-gradient">
                                Ongoing
                              </span>
                            </td>
                            <td>15 March 2020</td>
                ...
                <div className="card">
                  <div className="card-header pb-0 pt-4">
                    ...
                    <p className="tx-12 text-muted mb-0">
                      ...
                      the project and its idea and context .
                      <a href="">Learn more</a>
                    </p>
                  </div>
                    ...
                    <div className="list-group projects-list">
                      ...
                      >
                        <div className="d-flex w-100 justify-content-between">
                          ...
                          <small className="text-danger">
                            <i className="fa fa-caret-down mr-1"></i>5 days ago
                          </small>
                        </div>
                      ...
                      >
                        <div className="d-flex w-100 justify-content-between">
                          ...
                          <small className="text-success">
                            <i className="fa fa-caret-up mr-1"></i>2 days ago
                          </small>
                        </div>
                        <p className="mb-0 text-muted mb-0 tx-12">
                          Started:15-02-2020
                      ...
                      >
                        <div className="d-flex w-100 justify-content-between">
                          ...
                          <small className="text-danger">
                            <i className="fa fa-caret-down mr-1"></i>1 days ago
                          </small>
                        </div>
                        <p className="mb-0 text-muted mb-0 tx-12">
                          Started:26-02-2020
                        ...
                        <div className="time-activity">
                          <div className="item-activity">
                            <p className="mb-0">
                              ...
                              <span className="h6 ml-1 added-project">
                                AngularJS Template
                              </span>
                            </p>
              ...
              <div className="col-md-12 col-lg-6 col-xl-4">
                <div className="card">
                  <div className="card-header pt-4 pb-0">
                    ...
                    <p className="tx-12 text-muted mb-0">
                      The Statistics You can also summarize your data in a
                      graphical display, such as histograms
                      <a href="">Learn more</a>
                    </p>
                  </div>
                  ...
                  <div className="task-stat pb-0">
                    <div className="d-flex tasks">
                      <div className="mb-0">
                        <div className="h6 fs-15 mb-0">
                          <i className="far fa-dot-circle text-primary mr-2"></i>
                          Completed Tasks
                        </div>
                        <span className="text-muted tx-11 ml-4">
                          8:00am - 10:30am
                        </span>
                      </div>
                    ...
                    <div className="d-flex tasks">
                      <div className="mb-0">
                        <div className="h6 fs-15 mb-0">
                          <i className="far fa-dot-circle text-pink mr-2"></i>
                          Inprogress Tasks
                        </div>
                        <span className="text-muted tx-11 ml-4">
                          8:00am - 10:30am
                    ...
                    <div className="d-flex tasks">
                      <div className="mb-0">
                        <div className="h6 fs-15 mb-0">
                          <i className="far fa-dot-circle text-success mr-2"></i>
                          On Hold Tasks
                        </div>
                        <span className="text-muted tx-11 ml-4">
                          8:00am - 10:30am
                    ...
                    <div className="d-flex tasks mb-0 border-bottom-0">
                      <div className="mb-0">
                        <div className="h6 fs-15 mb-0">
                          <i className="far fa-dot-circle text-purple mr-2"></i>
                          Pending Tasks
                        </div>
                        <span className="text-muted tx-11 ml-4">
                          8:00am - 10:30am
